                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <?php foreach ($models as $detail): ?>
                                    <tr style="background: none;">
                                        ...
                                        <td class="text-center"><?= $detail->administrator_name ? $detail->administrator_name : $detail->department_name; ?></td>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <?php foreach ($correctProfit as $item): ?>
                                    <tr style="background: none;">
                                        ...
                                        <td class="text-center"><?= $item->administrator_name ? $item->administrator_name.'/'.$item->department_name.'/'.$item->company_name : $item->department_name; ?></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body input_box">
                ...
                <?= \yii\helpers\Html::activeHiddenInput($correctForm,'department_id',['value' => $model->id]) ?>
            </div>
