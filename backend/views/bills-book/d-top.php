	...
	<div class="equiry-month">
        <?php
            ...
            $form = \yii\bootstrap\ActiveForm::begin([
                'action' => '/bills-book/' . Yii::$app->controller->action->id.'?did=' .$id,
                'layout' => 'inline',
                'method' => 'get',
            ]); ?>
            <b>查询月份</b>
	...
	<div class="tally-details-content row">
		<div class="col-lg-5">
	        <div class="personal-detail navy-bg clearfloat">
                <div class="personal-head-portrait" style="text-align:center;background: none;padding: 0;">
	        ...
	        <div class="bills-month-detail clearfloat">
	            <div class="bills-month-order">
	                ...
	                <div class="bills-month-order-item clearfloat">
	                	<p>参与预计利润计算订单数量：</p>
	                	<span><?= $orderCalculateCollect['order_count'] ? $orderCalculateCollect['order_count'] : 0; ?>单</span>
	                </div>
	                <div class="bills-month-order-item clearfloat">
	                	<p>参与预计利润计算的退款订单数量：</p>
	                	<span><?= $orderCalculateCollect['refund_order_count'] ? $orderCalculateCollect['refund_order_count'] : 0; ?>单</span>
	                </div>
	                <div class="bills-month-order-item clearfloat">
	                	<p>参与预计利润计算的取消订单数量：</p>
	                	<span><?= $orderCalculateCollect['cancel_order_count'] ? $orderCalculateCollect['cancel_order_count'] : 0; ?>单</span>
	                </div>
	                <p class="bills-updatetime">更新时间：<?= $orderCalculateCollect['expect_profit_time'] ? date('Y-m-d H:i:s',$orderCalculateCollect['expect_profit_time']) : '--'; ?></p>
	            </div>
	    					...
	    					<div class="bills-income-data">
	    						<div class="bills-income-list clearfloat">
		    						<div class="bills-income-li">
		    							<p>参与计算订单预计利润金额</p>
		    							<span><?= $orderCalculateCollect['order_expected_amount'] ? Decimal::formatYenCurrentNoWrap($orderCalculateCollect['order_expected_amount']) : 0; ?></span>
		    						</div>
		    						<div class="bills-income-li">
		    							<p>更正订单预计利润金额</p>
		    							<span><?= $orderCalculateCollect['correct_expected_amount'] ? Decimal::formatYenCurrentNoWrap($orderCalculateCollect['correct_expected_amount']) : 0; ?></span>
		    						</div>
		    					</div>
		    					<div class="bills-income-list clearfloat">
		    						<div class="bills-income-li">
		    							<p>结转订单预计利润金额</p>
		    							<span><?= $orderCalculateCollect['knot_expected_amount'] ? Decimal::formatYenCurrentNoWrap($orderCalculateCollect['knot_expected_amount']) : 0; ?></span>
		    						</div>
		    						<div class="bills-income-li">
		    							<p></p>
		    							<span></span>
	    				...
	    				<div class="bills-income-content">
	    					<div class="bills-income-data">
	    						<div class="bills-income-list clearfloat">
		    						<div class="bills-income-li">
		    							<p>参与计算订单提成收入</p>
		    							<span><?= $orderPerformanceCollect['total_performance_amount'] ? $orderPerformanceCollect['total_performance_amount'] : 0; ?></span>
		    						</div>
		    						<div class="bills-income-li">
		    							<p>阶梯算法订单提成收入</p>
		    							<span><?= $orderPerformanceCollect['ladder_amount'] ? $orderPerformanceCollect['ladder_amount'] : 0; ?></span>
		    						</div>
		    					</div>
		    					<div class="bills-income-list clearfloat">
		    						<div class="bills-income-li">
		    							<p>更正订单提成收入</p>
		    							<span><?= $orderPerformanceCollect['correct_amount'] ? $orderPerformanceCollect['correct_amount'] : 0; ?></span>
		    						</div>
		    						<div class="bills-income-li">
		    							<p>固定提点订单提成收入</p>
		    							<span><?= $orderPerformanceCollect['fix_point_amount'] ? $orderPerformanceCollect['fix_point_amount'] : 0; ?></span>
		    						</div>
		    					</div>
	    					</div>
	    					<div class="bills-income-time">
