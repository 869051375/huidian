...
/**
 * This is the model class for table "customer_operate_record".
 *
 * @property integer $id
 ...
 */
class OperateCustomerRecord extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'customer_operate_record';
    }
    ...
    public  static function  Operate($data){
        ...
        OperateCustomerRecord::find()->createCommand()->insert(OperateCustomerRecord::tableName(),[
